...
-- RESET AND CREATE - Ejecutar si ya tienes datos y quieres empezar de cero
-- ⚠️ ADVERTENCIA: Esto borrará TODOS los datos existentes

-- =====================
-- DROP EXISTING (en orden inverso de dependencias)
-- =====================
...
-- SUCCESS MESSAGE
-- =====================
-- Si ves este mensaje, el schema se ejecutó correctamente
SELECT 'InventAgency Platform Schema creado exitosamente!' as message;
